...
public class ASlot : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    public bool hovering;

    private AItemSO heldItem;
    ...
    public void SetItem(AItemSO item, int amount = 1)
    {
        heldItem = item;
        itemAmount = amount;
